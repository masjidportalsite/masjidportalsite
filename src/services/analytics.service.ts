...
export class AnalyticsService {
  ...
  async getDashboardSummary(): Promise<ServiceResult<DashboardStats>> {
    ...
    try {
      ...
      return createSuccess({
        ...
        activeProgramsCount: 8, // Placeholder
      ...
      console.error('[AnalyticsService.getDashboardSummary] Critical Pool Error:', error);
  ...
  async getDetailedAnalytics(): Promise<ServiceResult<DetailedAnalytics>> {
    ...
    try {
      ...
      console.error('[AnalyticsService.getDetailedAnalytics] Critical Pool Error:', error);
